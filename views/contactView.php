            ...
            <div class="card_container">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas_ajouter" aria-labelledby="offcanvasRightLabel">
                    <div class="offcanvas-header">
                        <h6 class="offcanvas-title" id="offcanvasRightLabel">Nouveau Contact</h6>
                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>
                    <div class="offcanvas-body">
                        <div id="errorDiv"></div>
                        <form class="form-control" id="form_ajouter" action="controllers/contactController.php" method="POST">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas_modifier" aria-labelledby="offcanvasRightLabel">
                    <div class="offcanvas-header">
                        <h6 class="offcanvas-title" id="offcanvasRightLabel">Modification Contact</h6>
                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>
                    <div class="offcanvas-body">
                        <div id="errorDiv_modif"></div>
                        <form class="form-control" id="form_modifier" action="controllers/contactController.php" method="POST">
                            <div class="mb-3 col-12">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Détail Contact</h1>
                ...
                <div class="d-flex align-items-center justify-content-end mb-3">
                    ...
                    <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_ajouter" aria-controls="offcanvas_ajouter">Nouveau Contact</button>
                </div>
                                ...
                                columns: [{
                                    ...
                                    },
                                    {
                                        ...
                                        render: function(data, type, row) {
                                            ...
                                            return '<button class="me-4 bg-transparent text-info"  onclick="modifier(' + row.id + ')"><i class="fa-solid fa-pen-to-square"></i></button>' +
                                                '<button class="me-4 bg-transparent text-warning"  onclick="voir(' + row.id + ')"><i class="fa-solid fa-eye "></i></button>' +
                                                '<button class="bg-transparent text-danger"  onclick="supprimer(' + row.id + ')"><i class="fa-solid fa-trash "></i></button>';
                                        }
                                    }
            ...
            function voir(id) {
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        console.log(result);
                        if (donnees['contact'] !== null) {
                            let contact = donnees['contact']

                            $('.detailNom').text(contact['nom'])
                            $('.detailPrenom').text(contact['prenom'])
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (donnees['contact'] !== null) {
                            ...
                            $("#id_modif").val(contact['id']);
                            $("#nom_modif").val(contact['nom']);
                            $("#prenom_modif").val(contact['prenom']);
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (donnees['contact'] !== null) {
                            ...
                            Swal.fire({
                                title: "Êtes-vous sûr ?",
                                text: "Vous allez supprimer le contact <<" + contact['nom'] + ' ' + contact['prenom'] + ">>",
                                icon: "warning",
